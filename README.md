...
Do not double-click the HTML file to open it directly (this causes CORS issues when fetching data). Instead, use a local web server.

Navigate to the frontend directory containing 24pre.html.

Start a simple HTTP server. For example:Using Python: python -m http.server 3000

Using Node.js: npx http-server -p 3000

Or use the Live Server extension in VS Code.

Open your browser and navigate to the local server URL (e.g., http://localhost:3000/24pre.html).
